...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <form id="form1" runat="server">
        <div class="row">
            ...
            <input class="col-md-4 col-7 form-control" type="text" id="maKH" runat="server" placeholder="NDKxxxxx" />
            <span class="col-md-6 col-12 input-error text-danger col-form-label">
                <asp:RequiredFieldValidator ID="rfvMaKH" runat="server" ControlToValidate="maKH" ErrorMessage="Đây là thông tin bắt buộc." Display="Dynamic"></asp:RequiredFieldValidator>
                <asp:RegularExpressionValidator ID="revMaKH" runat="server" ControlToValidate="maKH" ErrorMessage="Mã khách hàng có dạng là NDKxxxxx, với mỗi x là mỗi chữ cái viết hoa hoặc chữ số" ValidationExpression="NDK[A-Z0-9]{5}" Display="Dynamic"></asp:RegularExpressionValidator>
            </span>
        </div>
        <div class="row">
